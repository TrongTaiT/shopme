...
public class SettingRepositoryTests {
	...
	@Test
	public void testCreateGeneralSettings1() {
	...
	public void testCreateCurrencySettings() {
		...
		Iterable<Setting> iterable = repo.saveAll(List.of(currencyId, symbol, //
				symbolPosition, decimalPointType, decimalDigits, thousandsPointType));
