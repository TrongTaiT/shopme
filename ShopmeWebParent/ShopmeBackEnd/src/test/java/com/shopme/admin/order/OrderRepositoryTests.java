...
public class OrderRepositoryTests {
	...
	@Test
	public void testCreateNewOrderWith1Product() {
		...
		orderDetail.setSubTotal(product.getPrice() * orderDetail.getQuantity());
	...
	public void testCreateNewOrderWithMultipleProduct() {
		...
		orderDetail1.setSubTotal(product1.getPrice() * orderDetail1.getQuantity());
